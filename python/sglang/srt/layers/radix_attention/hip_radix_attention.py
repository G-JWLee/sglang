...
class HiPAttentionEnvs:
    def __init__(self):
        ...
        self.hip_prefill_dense_threshold = int(os.getenv('HIP_PREFILL_DENSE_THRESHOLD', '12288'))
        self.hip_decode_dense_threshold = int(os.getenv('HIP_DECODE_DENSE_THRESHOLD', '12288'))
